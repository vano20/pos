...
-- Started on 2019-03-22 10:07:48
...
-- Name: orders_id; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.orders_id OWNER TO postgres;
...
CREATE TABLE public.orders (
    id integer DEFAULT nextval('public.orders_id'::regclass) NOT NULL,
...
INSERT INTO public.order_detail VALUES (1, 2, 1, 3, 1000, '2019-03-22 03:29:14', '2019-03-22 03:29:14', 1);
INSERT INTO public.order_detail VALUES (2, 3, 3, 10, 1000, '2019-03-22 03:29:53', '2019-03-22 03:29:53', 1);
...
INSERT INTO public.orders VALUES (2, '00000001', 1, 3000, '2019-03-22 03:29:14', '2019-03-22 03:29:14', 1);
INSERT INTO public.orders VALUES (3, '00000002', 1, 10000, '2019-03-22 03:29:53', '2019-03-22 03:29:53', 0);
...
INSERT INTO public.product VALUES (2, 'Sukro Kacang Atom', 'This product 2 is updated from category 1', 1000, 99, '2019-03-21 14:51:55.621875', '2019-03-22 03:28:38', 1);
INSERT INTO public.product VALUES (1, 'RedBull Energy Drink', 'This product 1 is updated from category 1', 1000, 96, '2019-03-21 14:51:55.594149', '2019-03-22 03:29:14', 2);
INSERT INTO public.product VALUES (3, 'Thai Tea', 'This product 1 is updated from category 2', 1000, 89, '2019-03-21 14:51:55.622608', '2019-03-22 03:29:53', 2);
...
INSERT INTO public.usergroup VALUES (3, 'Kasir', 'kasir penjualan');
...
INSERT INTO public.users VALUES (1, 2, 'vano20', 'demo', 'Savano miatama', 1);
INSERT INTO public.users VALUES (7, 3, 'fatimah', 'demo', 'Fatimah Humaira', 1);
...
SELECT pg_catalog.setval('public.orderdetail_id', 2, true);


--
-- TOC entry 2889 (class 0 OID 0)
-- Dependencies: 206
-- Name: orders_id; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.orders_id', 3, true);
...
SELECT pg_catalog.setval('public.usergroup_id', 3, true);
...
SELECT pg_catalog.setval('public.users_id', 9, true);
...
-- Completed on 2019-03-22 10:07:51
